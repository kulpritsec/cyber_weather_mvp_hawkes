...
from .routers.vuln_router import router as vuln_router
from .routers.ioc_enrichment import router as ioc_router
from .routers.ttp_heatmap import router as ttp_router
...
# Auth middleware — activated when CYBER_WEATHER_API_KEY is set
app.add_middleware(APIKeyMiddleware)

# CORS — reads from CYBER_WEATHER_CORS_ORIGINS env or falls back to dev defaults
app.add_middleware(
    CORSMiddleware,
